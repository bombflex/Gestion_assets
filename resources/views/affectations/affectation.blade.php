            ...
            <form action="{{route('affectation.store')}}" method="POST">
                ...
                <div class="modal-body row">
                    ...
                    <fieldset class="col-md-12 form-group border border-primary rounded p-2 " {{-- style="display: none" --}}>
                        <legend  class="w-auto col-form-label"> Téléphone </legend>
                            <div class="row">
                                <div class="col-md-6">
                                    <input type="text" class="form-group form-control form-control-user" id="invent_phone" name="invent_phone"  placeholder="Numéro d'inventaire...">   
                                    <input type="text" class="form-group form-control form-control-user" id="sim_phone" name="sim_phone"  placeholder="Numero de la SIM..."> 
                                    <input type="text" class="form-group form-control form-control-user" id="num_tel" name="num_tel"  placeholder="Numero de Téléphone..."> 
                                </div>
                                <div class="col-md-6">
                                    <input type="text" class="form-group form-control form-control-user" id="desc_phone" name="desc_phone"  placeholder="Description..." readonly> 
                                    <input type="text" class="form-group form-control form-control-user" id="serial_phone" name="serial_phone" placeholder="Numéro de Série..."readonly> 
                                </div>
                ...
                <div class="modal-body row">
                    ...
                    <fieldset class="form-group border border-primary rounded p-2 col-md-12" {{-- style="display: none" --}}>
                        <legend  class="w-auto col-form-label"> Téléphone </legend>
                            <div class="row">
                                <div class="col-md-6">
                                    <input type="hidden" id="m_invent_phone_old" name="m_invent_phone_old" > 
                                    <input type="text" class="form-group form-control form-control-user" id="m_invent_phone" name="m_invent_phone"  placeholder="Numéro d'inventaire..." >   
                                    <input type="text" class="form-group form-control form-control-user" id="m_sim_phone" name="m_sim_phone"  placeholder="Numero de la SIM..."> 
                                ...
                                <div class="col-md-6">
                                    <input type="text" class="form-group form-control form-control-user" id="m_desc_phone" name="m_desc_phone"  placeholder="Description..." readonly> 
                                    <input type="text" class="form-group form-control form-control-user" id="m_serial_phone" name="m_serial_phone" placeholder="Numéro de Série..."readonly> 
                                </div>
                ...
                <div class="modal-body row" id="view_affectation">
                    ...
                    <fieldset class="form-group border border-primary rounded p-2 col-md-12" {{-- style="display: none" --}}>
                        <legend  class="w-auto col-form-label"> Téléphone </legend>
                            <div class="row">
                                <div class="col-md-6">
                                    <input type="hidden" id="v_invent_phone_old" name="v_invent_phone_old" > 
                                    <input type="text" class="form-group form-control form-control-user" id="v_invent_phone" name="v_invent_phone"  placeholder="Numéro d'inventaire..." readonly>   
                                    <input type="text" class="form-group form-control form-control-user" id="v_sim_phone" name="v_sim_phone"  placeholder="Numero de la SIM..." readonly> 
                                ...
                                <div class="col-md-6">
                                    <input type="text" class="form-group form-control form-control-user" id="v_desc_phone" name="v_desc_phone"  placeholder="Description..." readonly> 
                                    <input type="text" class="form-group form-control form-control-user" id="v_serial_phone" name="v_serial_phone" placeholder="Numéro de Série..."readonly> 
                                </div>
...
<script>
    ...
    $("#add_affect").on('shown.bs.modal',function(){ 
        ...
        $("input#invent_phone").focusout(function(){
            var invent_num = $('#invent_phone').val();   
            var url = "{{ route('affectation.check','invent') }}";
            url = url.replace('invent', invent_num);
            $.get(url, function (data) {
                //var tab = data.length === 0;
    ...
    $("#edit_affect").on('shown.bs.modal',function(){
        ...
        t_inv_prev = $("#m_invent_phone").val();
        t_desk_prev = $("#m_desc_phone").val();
        t_ser_prev = $("#m_serial_phone").val();
        ...
        $("input#m_invent_phone").focusout(function(){
            var invent_num = $('#m_invent_phone').val();   
            var url = "{{ route('affectation.check','invent') }}";
            url = url.replace('invent', invent_num);
            $.get(url, function (data) {
                //var tab = data.length === 0;
                if (data.length != 0) {
                    ...
                    $("#m_invent_phone").val(t_inv_prev);
                    $("#m_desc_phone").val(t_desk_prev);
                    $("#m_serial_phone").val(t_ser_prev);
                }     
            })
...
$( "input#invent_phone").autocomplete({
    source: function( request, response ) {
        // Fetch data
        $.ajax({
        url:"{{route('completephone')}}",
        type: 'post',
        dataType: "json",
        data: {
            search: request.term
    ...
    select: function (event, ui) {
        // Set selection
        $('#invent_phone').val(ui.item.label); // display the selected text
        $('#desc_phone').val(ui.item.value); // save selected id to input
        $('#serial_phone').val(ui.item.serial); // save selected id to input
        return false;
    }
});
/* Edit */
...
$( "input#m_invent_phone").autocomplete({
    source: function( request, response ) {
        // Fetch data
        $.ajax({
        url:"{{route('completephone')}}",
    ...
    select: function (event, ui) {
        // Set selection
        $('#m_invent_phone').val(ui.item.label); // display the selected text
        $('#m_desc_phone').val(ui.item.value); // save selected id to input
        $('#m_serial_phone').val(ui.item.serial); // save selected id to input
        return false;
    }
});
</script>
  ...
  $(function () {
    ...
    var table = $('.data-table').DataTable({
        ...
        columns: [
            ...
            {data: 'inv_phone', name: 'inv_phone',width: '150px', class: 'text-left'},
            // {data: 'desc_phone', name: 'desc_phone'},
            // {data: 'serial_phone', name: 'serial_phone'},
            /* {data: 'sim_phone', name: 'sim_phone'},*/
            {data: 'numero_phone', name: 'num_phone',width: '150px', class: 'text-left'}, 
    ...
    $('body').on('click', '.editAffect', function () {
        ...
        $.get("{{ route('affectation.index') }}" +'/' + affect_id +'/edit', function (data) {
            ...
            $('#m_invent_phone').val(data[0].inv_phone); 
            $('#m_sim_phone').val(data[0].sim_phone); 
            $('#m_num_tel').val(data[0].numero_phone); 
            $('#m_desc_phone').val(data[0].desc_phone); 
            $('#m_serial_phone').val(data[0].serial_phone);  
   ...
   $('body').on('click', '.viewAffect', function () {
        ...
        /* var url = "{{ route('affectation.show','id_affect') }}";
            ...
            $.get(url, function (data) { */
                ...
                $('#v_invent_phone').val(data[0].inv_phone); 
                $('#v_sim_phone').val(data[0].sim_phone); 
                $('#v_num_tel').val(data[0].numero_phone); 
                $('#v_desc_phone').val(data[0].desc_phone); 
                $('#v_serial_phone').val(data[0].serial_phone);  
